...
# 训练 KNN
knn = KNeighborsClassifier(n_neighbors=45, weights='uniform', metric='euclidean')
...
plt.title('Confusion Matrix-KNN-Dataset7')
plt.savefig('Confusion Matrix-KNN-Dataset7.png', dpi=1200)  # 保存图像，设置分辨率为 600 dpi
plt.show()
